...
namespace ClassLibrary
{
    public class Repository
    {
        ...
        public Repository()//первоначальное содержимое репозитория
        {
            ...
            ListFotoEquipment.Add(new Camera(70.300, 474, "Japan", "Sony", "Alpha A7", "../../Images/sonyA7.jpeg", 24.7, 1, "MP4"));
            ...
            ListFotoEquipment.Add(new Flash(3.200, 200, "Japan", "Doerr", "D-AF-34", "../../Images/doerr34.jpeg", 34, 90));
